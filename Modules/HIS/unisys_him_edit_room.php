...
<body>
    ...
    $update  = $_GET['update'];
    $ret = "SELECT * FROM `UniSys_HIM_Rooms` WHERE id ='$update'  ";
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" value="<?php echo $row->type; ?>" required class="form-control" name="type">
                                        </div>
                                    </div>
                                    <button type="submit" name="update_room" class="btn btn-primary mt-3">Update Room</button>
                                </form>
                            </div>
                        </div>
                    </div>
