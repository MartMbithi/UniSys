...
if (isset($_POST['update_faculty'])) {
    ...
    $stmt->execute();
    if ($stmt) {
        $success = "Updated" && header("refresh:1; url=unisys_srm_faculties.php");
    } else {
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $faculty->faculty_code; ?>" name="faculty_code">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputEmail4">Faculty Name</label>
                                            <input type="text" class="form-control" value="<?php echo $faculty->faculty_name; ?>" name="faculty_name">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputEmail4">Head Of Faculty</label>
                                            <select class='form-control basic' name="faculty_head" id="">
                                                <option selected><?php echo $faculty->faculty_head; ?></option>
                                                <?php
