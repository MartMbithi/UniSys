        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    <li>
                        <a title="Landing Page" href="dashboard.php" aria-expanded="false"><span class="fa fa-home icon-wrap sub-icon-mg" aria-hidden="true"></span>
                            <span class="mini-click-non">Dashboard</span></a>
                    </li>
                    <li>
                        <a class="has-arrow" href="faculties.php" aria-expanded="false"><span class="fa fa-address-card icon-wrap"></span> <span class="mini-click-non">Faculties</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Faculties" href="faculties.php"><span class="mini-sub-pro">Faculties</span></a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a title="Courses" href="courses.php" aria-expanded="false"><span class="fa fa-book icon-wrap sub-icon-mg" aria-hidden="true"></span>
