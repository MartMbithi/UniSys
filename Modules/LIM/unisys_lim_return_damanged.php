...
if (isset($_POST['return_damanged'])) {
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div style="display: none;" class="form-group col-md-6">
                                            ...
                                            <input type="hidden" required value="Damanged" class="form-control" name="type">
                                        </div>
                                    ...
                                    <button type="submit" name="return_damanged" class="btn btn-primary mt-3">Return Damanged Book</button>
                                </form>
                            </div>
                        </div>
                    </div>
