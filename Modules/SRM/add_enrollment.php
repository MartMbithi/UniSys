                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="enroll_code" value="<?php echo $a; ?>-<?php echo $b; ?>" type="text" class="form-control">
                                                                <input name="enroll_id" value="<?php echo $facultyID; ?>" type="hidden" class="form-control" placeholder="Name">
                                                            </div>
                                                            <div class="form-group">
