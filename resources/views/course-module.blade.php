    ...
    <div class="container pb-5 mb-3">
      <div class="d-md-table w-100 p-4 p-lg-5 mb-30 box-shadow">
        <div class="d-md-table-cell align-middle pl-md-4 pl-lg-5 text-center text-md-left">
          ...
          <p class="text-muted">
            <li>Automatic enrollment: Logic within a Unisys, which registers and reminds students about mandatory courses.</li>
            <li>Enhanced Security: UniSys have single sign in, advanced authentication, and firewalls to ensure data security.</li>
            ...
            <b><li>Advanced Unisys - Course And Programme Information Management Module features</li></b>

            <p>In addition to these basic features, there are many advanced features, such as:</p>
            ...
            <li>Mobile friendly: The ability to use the UniSys with mobile devices (smartphones and tablets), including being able to study when offline.</li>
            <li>Custom branding: Unisys has  the ability to use a company’s own branding and/or can create custom themes for the UniSys user interface.</li>        
          </p>
        </div>
      </div>
    </div>
